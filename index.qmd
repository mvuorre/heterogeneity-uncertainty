...
authornote: |
  This work is available under a CC-BY license at <https://osf.io/preprints/psyarxiv/mwg4f>. Datasets discussed here are from Bolger et al., 2019 and Mah & Lindsay, 2024.
  ...
  html:
    ...
    other-links:
      - text: Preprint (PsyArXiv)
        href: https://osf.io/preprints/psyarxiv/mwg4f
        icon: file-pdf
...
The code and data underlying this work are archived on Zenodo at ({{<meta archive-url>}}). We reused openly available datasets from @bolgerCausalProcessesPsychology2019 and @mahVariabilitySubjectsFree2024.
