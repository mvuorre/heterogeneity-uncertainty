...
#| fig-width: 4.5
#| fig-height: 2.2
#| fig-cap: "Construction of point estimates of the limits of the heterogeneity interval. **A.** While $HI_{90}$ can be depicted on the probability density function (PDF), **B.** its construction is easier to depict on the cumulative distribution function (CDF), $\\Phi(x; \\beta_1, \\tau_1)$. To construct a 90% heterogeneity interval, we pass 0.05 and 0.95 to the inverse of the CDF: $HI_{90} = \\Phi^{-1}\\left([0.05, 0.95]; \\beta_1, \\tau_1 \\right)$."
